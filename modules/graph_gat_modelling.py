...
from modules.gnn.GATConvolution import GATC


class GraphGAT(nn.Module):
	"""Implementation of the graph model using GAT head.
		Params:
	...
	def __init__(self, caption_generator_state_dict=None, caption_generator_cache_dir=None, args=None):
		super().__init__()
		self.gatc = GATC(node_feat_dim=args.node_feat_dim, d_model=args.d_model, edge_dim=args.edge_dim,
	...
	def forward(self, geo_graph, video_mask=None,
		...
		fo_convolved = self.gatc(geo_graph)
