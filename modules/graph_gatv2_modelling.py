...
from modules.gnn.GATv2Convolution import GATv2C


class GraphGATv2(nn.Module):
	"""Implementation of the graph model using GATv2 head.
		Params:
	...
	def __init__(self, caption_generator_state_dict=None, caption_generator_cache_dir=None, args=None):
		super().__init__()
		self.gatv2c = GATv2C(node_feat_dim=args.node_feat_dim, d_model=args.d_model, edge_dim=args.edge_dim,
								project_edge_dim=args.project_edge_dim, more_skip=args.no_skip==False, last_average=args.last_average)
	...
	def forward(self, geo_graph, video_mask=None,
		...
		fo_convolved = self.gatv2c(geo_graph)
